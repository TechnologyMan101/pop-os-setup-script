...
mainmenu () {
	clear
 	tput setaf 3
	echo "==================================="
	echo " --- Pop!_OS Setup Script 5.17 ---"
	echo "==================================="
